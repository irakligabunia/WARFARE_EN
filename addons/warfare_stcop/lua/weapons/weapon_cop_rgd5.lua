...
SWEP.PrintName = "Handheld Grenade RGD-5 [HE]"
...
SWEP.ViewModel     = "models/wick/weapons/stalker/stcopwep/rgd_model.mdl"
SWEP.WorldModel    = "models/wick/weapons/stalker/stcopwep/w_rgd_model_stcop.mdl"
...
SWEP.OriginPos = Vector(-2.5, 0, -7.8)
			...
			if SERVER then
				timer.Simple(0.4, function()
					if IsValid(self) then
						...
						local nade = ents.Create("cop_grenade_rgd5")
