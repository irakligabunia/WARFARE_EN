...
SWEP.ViewModel     = "models/wick/weapons/stalker/stcopwep/vepr_model.mdl"
SWEP.WorldModel    = "models/wick/weapons/stalker/stcopwep/w_vepr_model_stcop.mdl"
