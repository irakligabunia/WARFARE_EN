...
function PANEL:Init()
	...
	function self.Knob:Paint(w,h)  --сам селектор
		local material = Material("daui/selector_scrlw.png") 
		surface.SetDrawColor(color_white) 
		surface.SetMaterial(material) 
		surface.DrawTexturedRect(0, 0, w, h) 
	end
...
derma.DefineControl( "StalkerDSlider", "", PANEL, "Panel" )
