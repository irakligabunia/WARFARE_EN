...
local function PaintFactionButton(s, w, h)
	local IconTable = {
	[characterFrame.loner] = "venty/stalker/loner_"..string.format("%s", s.selected)..".png",
	[characterFrame.bandit] = "venty/stalker/bandit_"..string.format("%s", s.selected)..".png",
	[characterFrame.clearsky] = "venty/stalker/clearsky_"..string.format("%s", s.selected)..".png",
	[characterFrame.dolg] = "venty/stalker/duty_"..string.format("%s", s.selected)..".png",
	[characterFrame.freedom] = "venty/stalker/freedom_"..string.format("%s", s.selected)..".png",
	[characterFrame.merc] = "venty/stalker/mercenary_"..string.format("%s", s.selected)..".png",
	[characterFrame.military] = "venty/stalker/military_"..string.format("%s", s.selected)..".png",
	[characterFrame.scientist] = "venty/stalker/ecologist_"..string.format("%s", s.selected)..".png",
	[characterFrame.monolit] = "venty/stalker/monolith_"..string.format("%s", s.selected)..".png",
			...
			AddLabel("Create a character", function()
				for k, v in SortedPairs(nut.faction.teams) do
					if not IsValid(characterFrame) then
						...
						characterFrame.loner:SetSize(64, 64)
						...
						characterFrame.bandit:SetSize(64, 64) --(ScrW()*0.038, ScrH()*0.066)
						...
						characterFrame.clearsky:SetSize(64, 64)
						...
						characterFrame.dolg:SetSize(64, 64)
						...
						characterFrame.freedom:SetSize(64, 64)
						...
						characterFrame.merc:SetSize(64, 64)
						...
						characterFrame.military:SetSize(64, 64)
						...
						characterFrame.scientist:SetSize(64, 64)
						...
						characterFrame.monolit:SetSize(64, 64)
						...
						characterFrame.trader:SetSize(64, 64)
						...
						characterFrame.lastday:SetSize(64, 64)
						...
						characterFrame.greh:SetSize(64, 64)
