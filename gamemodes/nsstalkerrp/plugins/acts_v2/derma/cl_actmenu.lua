...
function PANEL:Init()
	...
	--[[if not table.HasValue( LocalPlayer():getChar():getData("act_table"), self.button_a:GetValue()) then 
	...
	self.button_b:SetText("Sitting on ground #2")
	...
	self.button_c:SetText("Equip gear")
	...
	self.button_d:SetText("Stand with arms crossed")
	...
	self.button_e:SetText("Lie on your back")
	...
	self.button_j:SetText("Lean against the wall")
	...
	self.button_h:SetText("Press button")
	...
	self.button_g:SetText("Leaders' stance")
	...
	self.button_k:SetText("Leaders stance #2")
	...
	self.button_l:SetText("Sleep, while sitting on a chair") --(Лидер)
	...
	self.button_p:SetText("Lean against the table #1") --(Лидер)
	...
	self.button_o:SetText("Scan anomaly #1")
	...
	self.button_q:SetText("Scan anomaly #2")
	...
	self.button_r:SetText("Weapons' on shoulder")
	...
	self.button_x:SetText("Squatting")
	...
	self.button_y:SetText("Under influence of psi")
	...
	self.button_z:SetText("Talk on the radio")
	...
	self.button_aa:SetText("Sit on ground")
	...
	self.button_ad:SetText("Reclined sleep")
	...
	self.button_ae:SetText("Sleep on the ground")
	...
	self.button_ag:SetText("Lean against the table #1")
	...
	self.button_ah:SetText("Lean against the wall #2")
	...
	self.button_ai:SetText("Lean against the wall #2")
	...
	self.button_aj:SetText("Lean against the wall #3")
	...
	self.button_ak:SetText("Lean against the wall #4")
	...
	self.button_al:SetText("Hands in pocket")
	...
	self.button_am:SetText("Stand with weapon raised")
	...
	self.button_an:SetText("Attention")
	...
	self.button_ap:SetText("Search body")
	...
	self.button_aq:SetText("Campfire")
	...
	self.button_ar:SetText("Gop stop")
	...
	self.button_as:SetText("Surrender")
	...
	self.button_au:SetText("Injured")
	...
	self.button_av:SetText("Ask to lower weapon")
	...
	self.button_ax:SetText("Sleep on the ground #2")
	...
	self.button_az:SetText("Punch with stock")
