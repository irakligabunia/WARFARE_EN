...
function PANEL:Init(uniqueID)
	...
	self.bint_second:SetText("Bandage")
	...
	self.hand_flashlight:SetText("Handheld flashlight")
	...
	self.dozimetr:SetText("Dosimeter")
	...
	self.samodel:SetText("Homemade detector")
	...
	self.fire_kit:SetText("Ignition tools")
	...
	self.fire_kit_second:SetText("Ignition tools")
	...
	self.kit_food:SetText("Food production kit")
	...
	self.pecka:SetText("Homemade hiking stove")
	...
	self.sleeping_bag:SetText("Sleeping bag")
	...
	self.polev_bag:SetText("Field backpack")
	...
	self.pohod_bag:SetText("Field backpack")
	...
	self.hunter_kit:SetText("Hunting kit")
	...
	self.qr:SetText("Rapid Release System (QR)")
	...
	self.metal_plate:SetText("Iron plate")
	...
	self.metal_plate_second:SetText("Iron plate")
	...
	self.verb_gorb:SetText("Camel hunch")
	...
	self.samodel_knife:SetText("Homemade knife")
	...
	self.samodel_knife_second:SetText("Homemade knife")
	...
	self.exp_rgd:SetText("Explosive")
	...
	function self:Paint( w, h )
		...
		draw.DrawText("Crafting", "Roh20", ScrW() * 0.005, ScrH() * 0.003, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT ) --надпись шапки
		...
		draw.DrawText("Crafting recipes", "Roh20", ScrW() * 0.215, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )
