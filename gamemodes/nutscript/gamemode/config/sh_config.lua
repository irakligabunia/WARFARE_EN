...
nut.config.add("chatRange1", 1, "The maximum distance a person's IC chat message goes to.", nil, {
	form = "Float",
	data = {min = 1, max = 1},
	category = "chat"
})
...
nut.config.add("music", "music/half-life17.mp3", "The default music played in the character menu.", nil, {
	category = "appearance"
})
