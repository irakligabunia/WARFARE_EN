...
PLUGIN.author = "Chessnut&ЕбалВасВРот"
	...
	function PLUGIN:HUDPaint()
		...
		if (fraction > 0) then
			...
			for k, v in ipairs(weapons) do
				...
				local color = ColorAlpha(k == self.index and Color(62, 95, 138,opacity) or Color(211, 211, 211, opacity), (255 - math.abs(theta * 3) * 255) * fraction)
				local lastY = 0
				...
				surface.SetFont("dobi4ikxyecockft123123123")
				...
				cam.PushModelMatrix(matrix)
					nut.util.drawText(v:GetPrintName():upper(), 2, ty/2, color, 0, 1, "dobi4ikxyecockft123123123")
