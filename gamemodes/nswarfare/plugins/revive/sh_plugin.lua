...
if (CLIENT) then
	...
	function nut.hud.drawDeath()
		...
		local tx, ty = nut.util.drawText("Lost to ", ScrW()/2, ScrH()/2.2, Color(255, 140, 0, aprg2 * 255), 1, 1, "DeadBigFontForSafe", aprg2 * 255)
		local tx, ty = nut.util.drawText("the Zone...", ScrW()/2, ScrH()/1.9, Color(255, 140, 0, aprg2 * 255), 1, 1, "DeadBigFontForSafe", aprg2 * 255)
	end
end
