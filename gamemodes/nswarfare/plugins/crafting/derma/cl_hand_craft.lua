...
function PANEL:Init(uniqueID)
	...
	self.samodel:SetText("Handcrafted Detector")
	...
	self.kit_food:SetText("Cooking Kit")
	...
	self.pohod_bag:SetText("Travelling Backpack")
	...
	self.samodel_knife:SetText("Knife")
	...
	self.samodel_knife_second:SetText("Knife")
	...
	self.exp_rgd:SetText("Explosive Charge")
	...
	self.exp_f1:SetText("Explosive Charge")
	...
	function self:Paint( w, h )
		...
		draw.DrawText("Crafted Items", "Roh20", ScrW() * 0.005, ScrH() * 0.003, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT ) --надпись шапки
		...
		draw.DrawText("Recipe list", "Roh20", ScrW() * 0.215, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )
