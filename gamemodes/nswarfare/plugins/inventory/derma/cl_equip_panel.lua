...
function PANEL:Paint(w, h)
	...
	draw.DrawText("NOT", "Roh25", ScrW() * 0.151, ScrH() * 0.223, Color(255, 255, 255, 210), TEXT_ALIGN_CENTER ) --верхняя альфа надпись

	draw.DrawText("IMPLEMENTED YET", "Roh25", ScrW() * 0.15, ScrH() * 0.2535, Color(255, 255, 255, 210), TEXT_ALIGN_CENTER ) --нижняя альфа надпись
end
