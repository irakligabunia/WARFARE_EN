...
function PANEL:Init(uniqueID)
	...
	self.meat_plot:SetText("Mystery Meat")
	...
	self.meat_psevdosobaki:SetText("Dogmeat")
	...
	self.kanistra:SetText("Fuel Canister")
	...
	function self:Paint( w, h )
		...
		draw.DrawText("Selected Ingridient", "Roh20", ScrW() * 0.01, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )

		draw.DrawText("Ingridients", "Roh20", ScrW() * 0.215, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )
