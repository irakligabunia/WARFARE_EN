...
function PANEL:Init(uniqueID)
	...
	self.meat_kaban:SetText("Boar meat")
	...
	self.meat_slep_kaban:SetText("Blind dog meat")
	...
	self.meat_plot:SetText("Flesh meat")
	...
	self.meat_psevdosobaki:SetText("Pseudo dog meat")
	...
	self.ruka_snorka:SetText("Snork hand")
	...
	self.meat_tywkan:SetText("Tushanko meat")
	...
	self.drevesny_ygol:SetText("Charcoal")
	...
	self.kanistra:SetText("Petrol canister")
	...
	self.ballon_s_gasom:SetText("Balloon with gas")
	...
	function self:Paint( w, h )
		...
		draw.DrawText("Cooking", "Roh20", ScrW() * 0.005, ScrH() * 0.003, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT ) --надпись шапки
		...
		draw.DrawText("Selected ingredient", "Roh20", ScrW() * 0.01, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )

		draw.DrawText("Ingredients", "Roh20", ScrW() * 0.215, ScrH() * 0.0555, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )
		...
		draw.DrawText("Selected fuel", "Roh20", ScrW() * 0.01, ScrH() * 0.2455, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )

		draw.DrawText("Fuel", "Roh20", ScrW() * 0.215, ScrH() * 0.2455, Color(255, 255, 255, 210), TEXT_ALIGN_LEFT )
