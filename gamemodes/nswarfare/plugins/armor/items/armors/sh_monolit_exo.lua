ITEM.name = "Exoskeleton «Monolith»"
ITEM.desc = "A mass produced exoskeleton made for the ,,holy'' fighters of Monolith"
ITEM.price = 255240
ITEM.ric = 30
ITEM.dmgsteal = 50
ITEM.exRender = false
...
ITEM.model = "models/kek1ch/monolith_exo_outfit.mdl"
ITEM.width = 2
ITEM.height = 3
ITEM.iconCam = {
	pos = Vector(-1, 0, 200),
