ITEM.name = "Combat Suit «Sunrise»"
ITEM.desc = "The most common suit in the Zone, coated in kevlar and ceramic plates although no protection from anomalies"
ITEM.price = 21006
ITEM.ric = 20
ITEM.dmgsteal = 30
ITEM.exRender = false
...
ITEM.height = 3
ITEM.iconCam = {
	pos = Vector(4.1999998092651, 2.5999999046326, 200),
	ang = Angle(90, 0, 180),
	fov = 8
}
