...
function GM:SetupDatabase()
	...
	nut.db.hostname = "sql-us-northeast.nodecraft.com"
	-- The username to login to the database.
	nut.db.username = "np2_Fm1ClJPoG40R"
	-- The password that is associated with the username.
	nut.db.password = "mMuzdnqxWjt_zKi3QLqrBrel"
	-- The database that the user should login to.
	nut.db.database = "np2_SarVL6hmIeGwi7_NIW"
