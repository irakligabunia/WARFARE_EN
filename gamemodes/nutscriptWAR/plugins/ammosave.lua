...
nut.ammo.register("9x18")
nut.ammo.register("9x19")
nut.ammo.register("357")
nut.ammo.register("9x39")
nut.ammo.register("762x54")
nut.ammo.register("762x51")
nut.ammo.register("556x45")
nut.ammo.register("545x39")
nut.ammo.register("45acp")
nut.ammo.register("12x70")
nut.ammo.register("338")
nut.ammo.register("grenate")
nut.ammo.register("762x25")
nut.ammo.register("pkm")
nut.ammo.register("57x28")
nut.ammo.register("gaus")
